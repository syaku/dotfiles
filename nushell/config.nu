...
$env.config = {
    ...
    hooks: {
        ...
        pre_execution: [{
            print $"(ansi title)NuShell v.(version | get version)(ansi st)"
...
#        }
        {
            ...
            event: {
                send: executehostcommand,
                cmd: "ghq list --full-path | fzf | decode utf-8 | str trim | cd $in"
            }
        }
        {
            name: undo_change
        ...
        }
        {
            ...
            event: {
                send: executehostcommand,
                cmd: "fd --type d | fzf | decode utf-8 | str trim | z $in"
            }
        }
    ]
}
