...
- 検証十分性 (常時評価): Verification 節が Approach / Design / Phase の各成果を覆えているか。Phase 節があれば Phase 別に検証可能か。逆方向も同じ観点で評価する——検証装置が成果物より大きい・Acceptance の観測に不要な検証基盤の新設は過大として指摘する (検証の比例性)。
